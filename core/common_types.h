 ...
 * Election statistics
 *
 * These metrics are logged during experiments.
 *********************************************************************/
 ...
 *
 * Used to emulate dynamic wireless conditions.
 *********************************************************************/
 ...
 * RAFT message types
 *
 * These represent the logical packet purpose.
 *********************************************************************/
 ...
 *
 * Every UDP packet begins with this structure.
 *********************************************************************/
 ...
 * RAFT vote request
 *
 * Used by candidate during election to request votes from peers.
 *********************************************************************/
 ...
 * RAFT vote response
 *
 * Follower responds with this after receiving a vote request.
 *********************************************************************/
 ...
 *
 * Used by leader for heartbeats and log replication.
 *********************************************************************/
 ...
 *
 * Follower responds with this after append entries.
 *********************************************************************/
 ...
 *
 * These become paper metrics later.
 *********************************************************************/
...
/*********************************************************************
 * State change callback prototype
 *
 * Called whenever the RAFT node transitions between states.
 * Used by main.c to log state transitions and measure election latency.
 *********************************************************************/
 ...
 *
 * The network layer calls these when packets arrive.
 *********************************************************************/
